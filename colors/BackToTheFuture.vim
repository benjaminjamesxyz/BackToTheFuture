...
let g:colors_name = "BackToTheFuture"
"--------------------------------------------------------------------------------------------------------------------------------------------------
" Color Palette                                             " Syntax-group
"--------------------------------------------------------------------------------------------------------------------------------------------------
let s:SpanishRoast                  = { "gui": "#242F4A" }  " Comment
let s:Dark                          = { "gui": "#1D222E" }  " Visual
let s:PurplHeart                    = { "gui": "#6628A4" }  " Directory
let s:MiddleYellow                  = { "gui": "#FFEA00" }  " Warning
let s:BlackKnightDark               = { "gui": "#040917" }  " Background, TabLineSel
let s:SpanishRoastDark              = { "gui": "#08122C" }  " Background, TabLineSel
...
let s:AbyssalDepths                 = { "gui": "#122968" }  " TabLine, TabLineFill
...
call s:h("VertSplit", s:White, s:BlackKnightDark, "")
